...
This way, you do not need to calculate any center distances. If any factor loading is below 0.1 or any center distance below 0, it is set to that value and a warning is displayed.

Consider issuing desired input features on [github](https://github.com/NilsPetras/IPV/issues).
