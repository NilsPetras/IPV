...
#### 4.2. Size of chart elements {#size}
...
The font can be changed using the `font = ` parameter. The package [extrafont](https://cran.r-project.org/package=extrafont) allows access to many more fonts. For changes to the font size, see [section 4.2](#size).
