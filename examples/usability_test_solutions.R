...
## Task 6/10:
# Use an IPV function to create the actual plot from coord.
task6 <- plot_nested(coord,filename = "task6")
# Have a look at the .pdf file you just created.

## Task 7/10:
# Change your function calls creating a version of the plot where everything is
# about 44% bigger.
task7 <- plot_nested(coord,filename = "task7",size = 1.44)
...
task8 <- plot_nested(coord,filename = "task8",extra_arrows = T)
# Have a look at the .pdf file you just created.
...
# make it look better.
task9 <- plot_nested(coord,filename = "task9",extra_arrows = T, width_circles = 3)
