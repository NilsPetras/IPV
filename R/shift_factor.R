#' Shift Factor
#'
#' Moves coordinates given by \code{\link{model_facets}} to position nested facet plots in \code{\link{model_nested}}.
#'
#' @param data list generated by \code{\link{model_facets}}.
#' @param x integer; horizontal shift.
#' @param y integer; vertical shift.
#'
#' @details Helper function of \code{\link{model_nested}}.
#'
