#' Model Facets
#'
#' Generates coordinates for a facet plot.
#'
...
#'
#' @details Use this function in conjunction with \code{\link{plot_facets}} for simple models.
#'
#' In a nested model, it is more efficient to use \code{\link{model_nested}} instead.
#' It automatically generates plot coordinates for all factors of the nested model.
#'
...
model_facets <- function(data,subradius,rotate=0) {
  ...
  # coordinates of latent facet correlation labels
    # n = 2 * number of correlations (each correlation label appears twice: once in each facet circle)
  n <- cplx*(cplx-1)
