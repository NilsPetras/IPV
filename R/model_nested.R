...
#'
#' @param data list generated by \code{\link{input_excel}}, or by hand, containing formatted data.
#' @param subradius integer; radius of the circles representing facets (same unit as center distances).
#' @param rotate integer between 0 and 2*pi; radian angle to rotate the plot counter-clockwise by.
#' @param subrotate integer between 0 and 2*pi; radian angle or vector of radian angles to rotate the nested plots counter-clockwise by.
#' @param rotate_title integer between 0 and 2*pi; radian angle to rotate the overall general factor label counter-clockwise by.
#' @param items logical; if \code{TRUE}, generates the coordinates for item plots for all factors by calling \code{\link{model_items}}.
#' @param cors logical; if \code{TRUE}, generates coordinates for latent correlations between factors and sets up a ring to plot them in. If \code{FALSE}, the ring and the correlations are omitted, simplifying the plot significantly.
#' @param cor_spacing integer; if \code{cors = TRUE}: width of the ring the latent correlations between factors are plotted in; defaults to 0.4.
#' @param relative_scaling integer; relative size of the global to the nested plots; defaults to 3.
#' @param extra_arrows data frame containing information about additional correlation arrows between facets of different factors; see examples.
#'
#' @details Use this function in conjunction with \code{\link{plot_nested}} for nested models.
#'
...
#'
#'
#' @return List containing coordinates of plot objects.
#'
