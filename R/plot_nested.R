#' Plot Nested
#'
#' Plots several correlated factors with their facets in one big nested plot.
#'
...
#' @param cor_labels logical; if \code{TRUE}, plots latent correlations between factors as text.
#' @param subfactor_cor_labels logical; if \code{TRUE}, plots latent correlations between facets as text.
#' @param colour character; name of the global accent colour.
#' @param subcolour character; name of the nested accent colour
#' @param extra_arrows logical; if \code{TRUE}, plots correlation arrows between facets of different factors.
...
#'
#' @details Use this function in conjunction with \code{\link{model_nested}} for nested models.
#'
#' The nested plot treats factors like facets of a global factor.
#' It uses facet plots for each factor similar to how \code{\link{plot_facets}} uses circles for facets.
#'
#' Rotate by changing your \code{\link{model_nested}} function call.
#'
#' To add extra_arrows, you need to provide additional information to \code{\link{model_nested}}.
#'
