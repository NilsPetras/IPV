...
#'@param width_circles integer; width of the global circle outlines (relative to
#'  default).
#'@param width_circles_inner integer; width of the nested circle outlines
#'  (relative to default).
#'@param width_tick integer; width of the global dotted axis tick line (relative
#'  to default).
...
#'
#'@return Object of the class "ggplot" and optionally the same object saved as a
#'  file.
#'
