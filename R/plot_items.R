...
#' @param color2 character; name of the second accent color; defaults to
#'   black.
...
plot_items <- function (
  ...
  # layers ordered from bottom to top
    ...
    ggplot2::geom_point(
      ggplot2::aes(x = 0, y = 0),
      color = paste("gray", 100 - 15 * fade - 60, sep = ""),
    ...
    ggforce::geom_circle(
      ...
      color = paste("gray", 100 - 5 * fade - 25, sep = ""),
      linetype = "dotted",
    ...
    ggforce::geom_circle(
      ...
      ggplot2::aes_string(x0 = "x", y0 = "y", r = "r"),
      color = paste("gray", 100 - 5 * fade - 80, sep = ""),
      linetype = "dotted",
      size = size * min(size, .5) * width_grid) +
