...
#'   to; filename extension added automatically.
#' @param width integer; width of the .pdf document; defaults to 10; dpi is
#'   3000.
#' @param height integer; height of the .pdf document; defaults to 10, dpi is
#'   3000.
...
#'   tick
#' @param size_title integer; font size of the test label (relative to
#'   default).
...
#' @param size_grid integer; width of the dotted grid lines (relative to
#'   default).
