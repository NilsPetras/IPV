#' Plot Facets
#'
#' Plots a factor and its facets as circles.
#'
#' @param coor list generated by \code{\link{model_facets}} or \code{\link{model_nested}}.
...
#' @param cor_labels logical; if \code{TRUE}, plots latent correlations between facets as text.
...
#'
#' @details Use this function in conjunction with \code{\link{model_facets}} or \code{\link{model_nested}} for simple models.
#'
#' Facets are displayed using the average center distance of their items
...
plot_facets <- function(coor,size=1,filename,
                      width=10,height=10,colour="black",cor_labels=TRUE,tick=.1,font="sans",
